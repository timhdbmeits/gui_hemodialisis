...
sys.stderr.write("Total value: 00:05:00\n")
...
sys.stderr.write("Elapsed value: 00:00:10\n")
sys.stderr.write("Elapsed value: 00:00:50\n")
sys.stderr.write("Total complete: 50%\n")
sys.stdout.write("country=Nederland\n")
flush_then_wait()

sys.stderr.write("Elapsed value: 00:01:10\n")
